...
public class Shelter {
    ...
    private String contactNumber; // контактные данные охраны
    ...
    private String info;  //Информация об адресе и расписании рабочих часов
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, shelter.id) && Objects.equals(chatId, shelter.chatId) && Objects.equals(clientName, shelter.clientName) && Objects.equals(contactNumber, shelter.contactNumber) && Objects.equals(adoptedAnimals, shelter.adoptedAnimals) && Objects.equals(routeMapUrl, shelter.routeMapUrl) && Objects.equals(info, shelter.info);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, chatId, clientName, contactNumber, adoptedAnimals, routeMapUrl, info);
    }
